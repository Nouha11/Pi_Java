...
public class AdminDashboardController {
    ...
    @FXML private Button btnToggleUsers, btnToggleLibrary, btnToggleStudy, btnToggleGame, btnToggleQuiz;
    @FXML private VBox   usersGroup, libraryGroup, studyGroup, gameGroup, quizGroup;
            ...
            item.getChildren().forEach(n -> {
                if (n instanceof Label lbl) {
                    ...
                    if (!lbl.getStyleClass().contains("admin-nav-icon") &&
                        ...
                        // determine by position: first label = icon, second = text
                    }
