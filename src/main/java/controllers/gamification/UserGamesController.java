...
public class UserGamesController {
    ...
    private VBox buildCard(Game game) {
        // ── Icon / type badge ──
        Label icon = new Label(typeEmoji(game.getType()));
        icon.getStyleClass().add("quiz-card-icon");
        icon.setStyle(icon.getStyle() + "-fx-background-color: " + typeColor(game.getType()) + ";");
    ...
    private VBox statBox(String label, String value) {
        ...
        lbl.setStyle("-fx-text-fill: #718096; -fx-font-size: 10px;");
        Label val = new Label(value);
        val.setStyle("-fx-text-fill: #1e2a5e; -fx-font-size: 16px; -fx-font-weight: bold;");
    ...
    private VBox miniStat(String value, String label) {
        ...
        v.setStyle("-fx-font-size: 12px; -fx-font-weight: bold; -fx-text-fill: #2d3748;");
        Label l = new Label(label);
        l.setStyle("-fx-font-size: 10px; -fx-text-fill: #a0aec0;");
    ...
    private Label badge(String text, String bg, String fg) {
        ...
        l.setStyle("-fx-background-color: " + bg + "; -fx-text-fill: " + fg + "; " +
                   "-fx-border-color: " + fg + "33; -fx-border-radius: 20; -fx-background-radius: 20; " +
