...
public class GeminiService {
    ...
    private static final String API_KEY = "AIzaSyByDLqgAUbxrv3O76nmhu_Y7blUSHvZrMg";
    private static final String API_URL = "https://generativelanguage.googleapis.com/v1beta/models/gemini-2.5-flash:generateContent?key=" + API_KEY;    private final HttpClient httpClient;
